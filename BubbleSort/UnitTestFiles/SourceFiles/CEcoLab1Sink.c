 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnSwap(/* in */ struct IEcoLab1Events* me, int pos1, int pos2) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
	...
	printf("Swapped position: %d and position: %d\n", pos1, pos2);

    return 0;
}

int16_t ECOCALLMETHOD CEcoLab1Sink_OnFinish(/* in */ struct IEcoLab1Events* me) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
	...
	printf("Bubble sort has been finished. Result:\n");
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_Advise(/* in */ struct CEcoLab1Sink* me, /* in */IBubleSort *pIEcoLab1) {
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_Unadvise(/* in */ struct CEcoLab1Sink* me, /* in */IBubleSort *pIBubleSort) {
    IEcoConnectionPointContainer* pCPC = 0;
    IEcoConnectionPoint * pCP = 0;
    int16_t result = 0;

    if (me->m_cCookie) {
        result = pIBubleSort->pVTbl->QueryInterface(pIBubleSort, &IID_IEcoConnectionPointContainer, (void**)&pCPC);
        if (result == 0) {
            result = pCPC->pVTbl->FindConnectionPoint(pCPC, &IID_IEcoLab1Events, &pCP);
            pCPC->pVTbl->Release(pCPC);
            pCPC = 0;
