...
typedef struct CEcoLab1Sink {
    ...
    int16_t (ECOCALLMETHOD *Advise)(/* in */ struct CEcoLab1Sink* me, /* in */IBubleSort *pIBubleSort);
    int16_t (ECOCALLMETHOD *Unadvise)(/* in */ struct CEcoLab1Sink* me, /* in */IBubleSort *pIBubleSort);
